...
import { create, destroy, edit, index, show, store, update } from '../workbench/resources/js/actions/App/Http/Controllers/PostController'

describe('index', async () => {
    test('properties', () => {
      expect(Object.keys(index)).toEqual(['form', 'definition', 'url', 'get', 'head'])
    })
...
describe('create', async () => {
    test('properties', () => {
      expect(Object.keys(create)).toEqual(['form', 'definition', 'url', 'get', 'head'])
    })
...
describe('store', async () => {
    test('properties', () => {
      expect(Object.keys(store)).toEqual(['form', 'definition', 'url', 'post'])
    })
...
describe('show', async () => {
    test('properties', () => {
      expect(Object.keys(show)).toEqual(['form', 'definition', 'url', 'get', 'head'])
    })
...
describe('edit', async () => {
    test('properties', () => {
      expect(Object.keys(edit)).toEqual(['form', 'definition', 'url', 'get', 'head'])
    })
...
describe('update', async () => {
    test('properties', () => {
      expect(Object.keys(update)).toEqual(['form', 'definition', 'url', 'patch'])
    })
...
describe('destroy', async () => {
    test('properties', () => {
      expect(Object.keys(destroy)).toEqual(['form', 'definition', 'url', 'delete'])
    })
